<template>
  <div class="space-y-6">
      ...
      <div class="flex justify-between items-center mb-4">
        <div>
          ...
          <p class="text-sm text-gray-600 mt-1">
            ...
            <a href="https://man7.org/linux/man-pages/man5/crontab.5.html" class="text-blue-600 hover:underline">Learn more</a>
          </p>
        </div>
        ...
        <div v-for="c in crons" :key="c.id" class="border border-gray-200 rounded-lg p-5 hover:border-gray-300 transition-colors">
          <div class="flex justify-between items-start">
            <div class="flex-1 min-w-0">
              ...
              <div v-if="c.site_domain" class="text-xs text-blue-500 mt-1">{{ c.site_domain }}</div>
            </div>
    ...
    <AddCronModal v-if="showAddModal" @close="showAddModal = false" @created="onCreated" />
  </div>
</template>
