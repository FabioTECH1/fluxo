<template>
  <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
    <div class="flex justify-between items-start mb-6">
      <div>
        <h2 class="text-lg font-semibold text-gray-900">Node.js</h2>
        <p class="text-sm text-gray-600 mt-1">View the current Node.js runtime configuration on your server.</p>
      </div>
