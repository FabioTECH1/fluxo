...
const sidebarItems = computed(() => {
  ...
  {
    to: `/sites/${id.value}/settings/vhost`,
    label: 'Vhost',
    icon: '<svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="16" rx="2"/><path stroke-linecap="round" d="M7 8h.01M10 8h.01M13 8h4M7 12h10M7 16h7"/></svg>',
  },
  ];
