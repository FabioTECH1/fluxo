...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("POST /api/v1/server/mysql/start", s.handleStartMySQL())
	s.mux.HandleFunc("POST /api/v1/server/mysql/stop", s.handleStopMySQL())
	s.mux.HandleFunc("POST /api/v1/server/redis/restart", s.handleRestartRedis())
	s.mux.HandleFunc("POST /api/v1/server/redis/start", s.handleStartRedis())
	s.mux.HandleFunc("POST /api/v1/server/redis/stop", s.handleStopRedis())
	s.mux.HandleFunc("POST /api/v1/server/postgres/restart", s.handleRestartPostgres())
	s.mux.HandleFunc("POST /api/v1/server/postgres/start", s.handleStartPostgres())
	s.mux.HandleFunc("POST /api/v1/server/postgres/stop", s.handleStopPostgres())
