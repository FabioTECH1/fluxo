...
Look for the `Fluxo bootstrap token` entry — use it with your chosen username to log in. That username becomes the permanent admin username going forward.
...
The reset command also reports the administrator username. Before the first account is claimed, both commands prompt you to choose a username for the initial login.
