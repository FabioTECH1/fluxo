...
<template>
  <div class="bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-100 antialiased transition-colors" style="font-family: Inter, system-ui, sans-serif">
    <header class="fixed top-0 inset-x-0 z-50 border-b border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-950/80 backdrop-blur-md">
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <nav class="hidden md:flex items-center gap-8 text-sm font-medium text-gray-600 dark:text-gray-400">
          <button @click="scrollTo('features')" class="hover:text-gray-900 dark:hover:text-gray-100 transition-colors">Features</button>
          <a href="/demo/sites" target="_blank" rel="noopener noreferrer" class="hover:text-gray-900 dark:hover:text-gray-100 transition-colors" @click="mobileMenuOpen = false">Demo</a>
          <button @click="scrollTo('install')" class="hover:text-gray-900 dark:hover:text-gray-100 transition-colors">Install</button>
          <a href="https://github.com/FabioTECH1/fluxo" target="_blank" class="hover:text-gray-900 dark:hover:text-gray-100 transition-colors">GitHub</a>
          ...
          <a href="/demo/sites" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-blue-600 text-white font-semibold text-sm hover:bg-blue-700 transition-colors shadow-sm">
            Live Demo →
          </a>
        </nav>
    ...
    <section class="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto text-center">
      <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-sm font-medium mb-8 border border-blue-200 dark:border-blue-800">
        🚀 v0.2.82 — Open Source
      </div>
      ...
      <p class="mt-6 text-lg sm:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
        Fluxo is a self-hosted control panel inspired by Laravel Forge. Manage Nginx sites, PHP-FPM pools, SSL certificates, databases, daemons, cron jobs, and zero-downtime deployments — all from a clean dashboard.
      </p>
      <div class="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
        <a href="/demo/sites" target="_blank" rel="noopener noreferrer" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl bg-blue-600 text-white font-semibold text-lg hover:bg-blue-700 transition-colors shadow-lg shadow-blue-600/20 dark:shadow-blue-600/10">
          Live Demo →
        </a>
        <button @click="scrollTo('install')" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 font-semibold text-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
          Install Now
        </button>
        <a href="https://github.com/FabioTECH1/fluxo" target="_blank" class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 font-semibold text-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
    ...
    <section id="features" class="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-900/50">
      <div class="max-w-6xl mx-auto">
        <div class="text-center mb-16">
          ...
          <p class="mt-4 text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">No monthly fees, no third-party dependencies. Run Fluxo on any VPS and get a full-featured control panel.</p>
        </div>
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <div class="p-6 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 hover:shadow-lg transition-shadow">
            <div class="w-10 h-10 rounded-lg bg-blue-100 dark:bg-blue-900/40 flex items-center justify-center text-blue-600 dark:text-blue-400 text-lg mb-4">⚡</div>
            <h3 class="font-semibold text-lg mb-2">Zero-Downtime Deployments</h3>
            <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">Deploy new releases alongside the running site and swap symlinks atomically. Rollback in one click.</p>
          </div>
          <div class="p-6 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 hover:shadow-lg transition-shadow">
            <div class="w-10 h-10 rounded-lg bg-green-100 dark:bg-green-900/40 flex items-center justify-center text-green-600 dark:text-green-400 text-lg mb-4">🔒</div>
            <h3 class="font-semibold text-lg mb-2">One-Click SSL</h3>
            <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">Issue and renew Let's Encrypt certificates for your domains from the dashboard. No SSH commands needed.</p>
          </div>
          <div class="p-6 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 hover:shadow-lg transition-shadow">
            <div class="w-10 h-10 rounded-lg bg-purple-100 dark:bg-purple-900/40 flex items-center justify-center text-purple-600 dark:text-purple-400 text-lg mb-4">🗄️</div>
            <h3 class="font-semibold text-lg mb-2">Database Management</h3>
            <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">Create and manage MySQL and PostgreSQL databases, users, and permissions — with an integrated grants editor.</p>
          </div>
          <div class="p-6 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 hover:shadow-lg transition-shadow">
            <div class="w-10 h-10 rounded-lg bg-amber-100 dark:bg-amber-900/40 flex items-center justify-center text-amber-600 dark:text-amber-400 text-lg mb-4">🔄</div>
            <h3 class="font-semibold text-lg mb-2">GitHub Integration</h3>
            <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">Connect your GitHub account, select repositories, inject deploy keys, and trigger deployments automatically on push.</p>
          </div>
          <div class="p-6 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 hover:shadow-lg transition-shadow">
            <div class="w-10 h-10 rounded-lg bg-rose-100 dark:bg-rose-900/40 flex items-center justify-center text-rose-600 dark:text-rose-400 text-lg mb-4">🛡️</div>
            <h3 class="font-semibold text-lg mb-2">Firewall & System</h3>
            <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">Manage UFW rules, systemd daemons, cron jobs, SSH keys, and monitor system metrics — CPU, memory, disk.</p>
          </div>
          <div class="p-6 rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 hover:shadow-lg transition-shadow">
            <div class="w-10 h-10 rounded-lg bg-cyan-100 dark:bg-cyan-900/40 flex items-center justify-center text-cyan-600 dark:text-cyan-400 text-lg mb-4">📜</div>
            <h3 class="font-semibold text-lg mb-2">Real-Time Logs & Terminal</h3>
            <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">Tail Nginx, PHP-FPM, and application logs via WebSocket. Execute commands directly from the web terminal.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div class="space-y-6 text-left">
          ...
          <p class="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
            Fluxo runs directly on clean operating systems without container virtualization overhead, providing maximum performance and CGo-free efficiency. Set up your panel on any standard virtual instance in minutes.
          </p>

          <div class="space-y-6 pt-2">
            <div class="flex gap-4">
              <div class="w-10 h-10 rounded-lg bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center shrink-0 text-blue-600 dark:text-blue-400 font-semibold text-lg">
                ⚡
              </div>
              <div>
                <h3 class="font-bold text-gray-900 dark:text-gray-100 text-base">One-Command Provisioning</h3>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1 leading-relaxed">
                  Our lightweight installer automatically configures Nginx, MariaDB, PHP runtimes, Certbot SSL utilities, and systemd services, leaving you with a fully secured server right away.
                </p>
              </div>
            </div>
            ...
            <div class="flex gap-4">
              ...
              <div>
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1 leading-relaxed">
                  Deploy on AWS, DigitalOcean, Hetzner Cloud, Google Cloud, Vultr, or your own dedicated bare metal server. No provider lock-in, just pure Linux capability.
                </p>
              </div>
            </div>
          </div>
    ...
    <section class="py-24 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto border-t border-gray-100 dark:border-gray-900">
      <div class="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div class="space-y-6 lg:order-first order-last text-left">
          ...
          <p class="text-gray-600 dark:text-gray-400 leading-relaxed text-sm">
            Deploy different application types in isolated environments. Fluxo manages system user permissions, virtual host routing, and dedicated runtime processes for each site.
          </p>
          ...
          <div class="grid sm:grid-cols-2 gap-4 pt-2">
            ...
            <div class="p-5 rounded-xl border border-gray-150 dark:border-gray-900 bg-white dark:bg-gray-900/40">
              ...
              <p class="text-[11px] text-gray-500 dark:text-gray-400 mt-1 leading-relaxed">
                Start, stop, and restart database engines (MariaDB, PostgreSQL, or Redis cache) and manage credentials and user grants from the interface.
              </p>
            </div>
            ...
            <div class="p-5 rounded-xl border border-gray-150 dark:border-gray-900 bg-white dark:bg-gray-900/40">
              ...
              <p class="text-[11px] text-gray-500 dark:text-gray-400 mt-1 leading-relaxed">
                Serve single-page frontend apps (Vue, React, Vite, or simple HTML/CSS/JS) with optimized virtual host configurations.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="relative flex justify-center items-center">
          ...
          <div class="relative w-full max-w-sm bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-2xl p-6 space-y-4 text-left">
            <h4 class="text-xs font-bold text-gray-900 dark:text-gray-100 flex items-center gap-1.5 pb-3 border-b border-gray-100 dark:border-gray-800">
              <span>✨</span> Create Site Wizard
            </h4>

            <div class="space-y-3">
              <div>
                <label class="block text-[9px] uppercase tracking-wider text-gray-400 font-bold mb-1">Application Type</label>
                <div class="w-full px-3 py-1.5 rounded-lg border border-gray-250 dark:border-gray-800 bg-gray-50 dark:bg-gray-950 text-xs text-gray-800 dark:text-gray-300 font-medium">
                  Laravel Application
                </div>
              </div>

              <div>
                <label class="block text-[9px] uppercase tracking-wider text-gray-400 font-bold mb-1">PHP Version</label>
                <div class="w-full px-3 py-1.5 rounded-lg border border-gray-255 dark:border-gray-800 bg-gray-55/50 dark:bg-gray-950 text-xs text-gray-800 dark:text-gray-300 font-medium flex justify-between items-center">
                  <span>PHP 8.4</span>
                  <span class="text-[9px] bg-green-105 text-green-700 dark:bg-green-950/50 dark:text-green-400 px-1.5 py-0.5 rounded font-bold">Active</span>
                </div>
              </div>

              <div>
                <label class="block text-[9px] uppercase tracking-wider text-gray-400 font-bold mb-1">Database Engine</label>
                <div class="w-full px-3 py-1.5 rounded-lg border border-gray-255 dark:border-gray-800 bg-gray-55/50 dark:bg-gray-955 text-xs text-gray-800 dark:text-gray-300 font-medium">
                  MySQL / MariaDB
                </div>
              </div>
              ...
              <div class="pt-2 space-y-2">
                <div class="flex items-center gap-2">
                  <span class="w-4 h-4 rounded-full bg-blue-50 dark:bg-blue-900/30 flex items-center justify-center text-[10px] text-blue-600 dark:text-blue-400 font-bold">✓</span>
    ...
    <section id="demo" class="py-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto text-center">
      ...
      <p class="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-10">Try the live demo to explore the dashboard. No sign-up required — just click and browse.</p>
      <a href="/demo/sites" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-3 px-8 py-4 rounded-xl bg-blue-600 text-white font-semibold text-lg hover:bg-blue-700 transition-colors shadow-lg">
        <svg class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
        Launch Demo
      </a>
    </section>

    <section id="install" class="py-24 px-4 sm:px-6 lg:px-8 bg-gray-50/50 dark:bg-gray-900/10 border-t border-gray-100 dark:border-gray-900/60 backdrop-blur-3xl relative overflow-hidden">
      <!-- Glow background -->
      ...
      <div class="max-w-6xl mx-auto grid lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div class="lg:col-span-5 space-y-6 text-left">
          ...
          <p class="text-gray-600 dark:text-gray-400 text-sm leading-relaxed font-sans">
            Deploy Fluxo directly to a clean server instance. The installer handles Nginx, PHP, MariaDB, Certbot SSL, and UFW firewall rules natively.
          </p>

          <div class="space-y-4 pt-2">
            <div class="flex items-center gap-3">
              <span class="w-6 h-6 rounded-full bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center text-xs text-blue-650 dark:text-blue-400">🐧</span>
              <span class="text-xs font-semibold text-gray-700 dark:text-gray-300">Ubuntu 22.04+ or Debian 12+</span>
            </div>
            <div class="flex items-center gap-3">
              <span class="w-6 h-6 rounded-full bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center text-xs text-blue-655 dark:text-blue-400">⚙️</span>
              <span class="text-xs font-semibold text-gray-700 dark:text-gray-300">Intel/AMD x86_64 or ARM64</span>
            </div>
            <div class="flex items-center gap-3">
              <span class="w-6 h-6 rounded-full bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center text-xs text-blue-655 dark:text-blue-400">🔑</span>
        ...
        <div class="lg:col-span-7 w-full">
          <div class="relative w-full bg-gray-950 dark:bg-black rounded-3xl border border-gray-200/60 dark:border-gray-850/60 shadow-2xl p-6 space-y-4">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-gray-900">
              ...
              <!-- Tab Selectors -->
              <div class="flex bg-gray-900 p-0.5 rounded-lg border border-gray-850 text-[10px] font-semibold text-gray-400 self-start sm:self-auto">
                <button 
            ...
            <div class="relative group min-h-[140px] text-left">
              <pre v-if="activeTab === 'install'" class="text-[11px] sm:text-[12px] font-mono text-gray-300 leading-relaxed overflow-x-auto">
...
<span class="text-blue-405 font-bold">sudo cat /home/fluxo/.fluxo_credentials</span></pre>
              ...
              <pre v-else-if="activeTab === 'upgrade'" class="text-[11px] sm:text-[12px] font-mono text-gray-300 leading-relaxed overflow-x-auto">
    ...
    <footer class="border-t border-gray-200 dark:border-gray-800 py-12 px-4 sm:px-6 lg:px-8">
      <div class="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-6 text-sm text-gray-500 dark:text-gray-500">
          <a href="https://github.com/FabioTECH1/fluxo" target="_blank" class="hover:text-gray-700 dark:hover:text-gray-300 transition-colors">GitHub</a>
          <a href="https://github.com/FabioTECH1/fluxo/releases" target="_blank" class="hover:text-gray-700 dark:hover:text-gray-300 transition-colors">Releases</a>
          <a href="https://github.com/FabioTECH1/fluxo/issues" target="_blank" class="hover:text-gray-700 dark:hover:text-gray-300 transition-colors">Issues</a>
        </div>
