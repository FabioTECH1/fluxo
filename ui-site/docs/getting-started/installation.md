...
curl -fsSL https://fluxo.fottify.com/install.sh | \
  FLUXO_VERSION=v0.4.31 sudo -E bash
```
...
```bash
curl -fsSLO https://github.com/FabioTECH1/fluxo/releases/download/v0.4.31/fluxo-release-attestation.json
