...
curl -fsSL https://fluxo.fottify.com/install.sh | \
  FLUXO_VERSION=v0.4.13 sudo -E bash
```
...
```bash
curl -fsSLO https://github.com/FabioTECH1/fluxo/releases/download/v0.4.13/fluxo-release-attestation.json
